...
public class Application {
    public static void main(String[] args) {
        ...
        /* 설명.
         *  i18n 소프트웨어의 국제화(Internationalization에서 첫 글자인 I와 마지막 글자인 n사이에
         *  알파벳 갯수가 18개)란?
         *  소프트웨어를 국제화 하기 위해서는 처리해야 할 작업이 많다.
         *   1. 언어, 지역별 번역
         *   2. OS/Plaform별 인코딩
         *   3. 문자열 치환 방법
        ...
        System.out.println(error404MessageKR);
        System.out.println(error500MessageKR);
        ...
        System.out.println(error404MessageUS);
        System.out.println(error500MessageUS);
    }
}
